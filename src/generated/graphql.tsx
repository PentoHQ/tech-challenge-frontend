...
export type RunningSessionQuery = {
  running_sessions: Array<
    { __typename?: 'running_sessions' } & Pick<
      Running_Sessions,
      'name' | 'startDate'
    >
  >;
...
export type UpdateSessionMutationVariables = Exact<{
  input?: Maybe<Sessions_Set_Input>;
...
export type SessionsQueryQueryHookResult = ReturnType<
  typeof useSessionsQueryQuery
>;
export type SessionsQueryLazyQueryHookResult = ReturnType<
  typeof useSessionsQueryLazyQuery
>;
...
export type RunningSessionQueryHookResult = ReturnType<
  typeof useRunningSessionQuery
>;
export type RunningSessionLazyQueryHookResult = ReturnType<
  typeof useRunningSessionLazyQuery
>;
...
export function useStartSessionMutation(
  ...
  return Apollo.useMutation<
    StartSessionMutation,
    StartSessionMutationVariables
  >(StartSessionDocument, options);
}
export type StartSessionMutationHookResult = ReturnType<
  typeof useStartSessionMutation
>;
